...
public class LineageSettingsProvider extends ContentProvider {
    ...
    // Must match definitions in fw/b packages/SettingsProvider/src/com/android/providers/settings/SettingsProvider.java
        ...
        switch (method) {
           ...
           case LineageSettings.CALL_METHOD_MIGRATE_SETTINGS_FOR_USER:
            ...
            case LineageSettings.CALL_METHOD_PUT_SYSTEM:
                ...
                callPutForUser(callingUserId, LineageSettings.System.CONTENT_URI, request, args);
                return null;
            case LineageSettings.CALL_METHOD_PUT_SECURE:
                ...
                callPutForUser(callingUserId, LineageSettings.Secure.CONTENT_URI, request, args);
                return null;
            case LineageSettings.CALL_METHOD_PUT_GLOBAL:
                enforceWritePermission(lineageos.platform.Manifest.permission.WRITE_SECURE_SETTINGS);
                callPutForUser(callingUserId, LineageSettings.Global.CONTENT_URI, request, args);
                return null;

            // List methods
            case LineageSettings.CALL_METHOD_LIST_SYSTEM:
                return callListForUser(callingUserId, LineageSettings.System.CONTENT_URI);
            case LineageSettings.CALL_METHOD_LIST_SECURE:
                return callListForUser(callingUserId, LineageSettings.Secure.CONTENT_URI);
            case LineageSettings.CALL_METHOD_LIST_GLOBAL:
                return callListForUser(callingUserId, LineageSettings.Global.CONTENT_URI);

            // Delete methods
            case LineageSettings.CALL_METHOD_DELETE_SYSTEM:
                enforceWritePermission(lineageos.platform.Manifest.permission.WRITE_SETTINGS);
                return callDeleteForUser(callingUserId, LineageSettings.System.CONTENT_URI, request);
            case LineageSettings.CALL_METHOD_DELETE_SECURE:
                enforceWritePermission(lineageos.platform.Manifest.permission.WRITE_SECURE_SETTINGS);
                return callDeleteForUser(callingUserId, LineageSettings.Secure.CONTENT_URI, request);
            case LineageSettings.CALL_METHOD_DELETE_GLOBAL:
                enforceWritePermission(lineageos.platform.Manifest.permission.WRITE_SECURE_SETTINGS);
                return callDeleteForUser(callingUserId, LineageSettings.Global.CONTENT_URI, request);
        }
    ...
    private Bundle callDeleteForUser(int callingUserId, Uri contentUri, String key) {
        final int rowsDeleted = deleteForUser(callingUserId, contentUri, NAME_SELECTION, new String[]{ key });
    ...
    private Bundle callListForUser(int callingUserId, Uri contentUri) {
    ...
    private void callPutForUser(int callingUserId, Uri contentUri, String key, Bundle args) {
    ...
    private int deleteForUser(int callingUserId, Uri uri, String selection, String[] selectionArgs) {
        if (uri == null) {
            throw new IllegalArgumentException("Uri cannot be null");
        }
