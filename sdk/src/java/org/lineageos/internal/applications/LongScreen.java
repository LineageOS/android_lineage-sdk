...
public class LongScreen {
    ...
    public LongScreen(Context context) {
        ...
        mMaxAspectRatio = resources.getFloat(
                org.lineageos.platform.internal.R.dimen.config_screenMaxAspectRatio);
    ...
    public float maxAspectRatioForPackage(String packageName) {
        return isSupported() && mApps.contains(packageName) ? mMaxAspectRatio : 0.0f;
    }
