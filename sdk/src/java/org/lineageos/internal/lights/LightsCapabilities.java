...
public final class LightsCapabilities {
    ...
    // Device has a multi-segment battery light that uses the
    // light alpha channel to represent the battery level.
    public static final int LIGHTS_SEGMENTED_BATTERY_LED = 16;
    // The notification light supports adjusting brightness using
    // the alpha channel.
