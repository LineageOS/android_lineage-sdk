...
public final class LineageNotificationLights {
    ...
    // Takes the lights settings as requested by a notification
    // and updates these values based on Lineage feature settings.
    // Returns null if lights should be turned off.
