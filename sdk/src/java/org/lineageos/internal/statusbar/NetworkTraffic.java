...
public class NetworkTraffic extends TextView {
    ...
    private static final int NETWORK_TRAFFIC_UNITS_KBPS = 0;
    private static final int NETWORK_TRAFFIC_UNITS_MBPS = 1;
    ...
    private LineageDarkReceiver mDarkReceiver = new LineageDarkReceiver() {
    ...
    private LineageVisibilityReceiver mVisibilityReceiver = new LineageVisibilityReceiver() {
    ...
    protected void onAttachedToWindow() {
        ...
        LineageStatusBarItemManager itemManager =
                LineageStatusBarItemUtil.findItemManager((View) this);
        itemManager.addDarkReceiver(mDarkReceiver);
        itemManager.addVisibilityReceiver(mVisibilityReceiver);
    ...
    private void updateSettings() {
        ...
        switch (mUnits) {
            case NETWORK_TRAFFIC_UNITS_KBPS:
                mAutoHideThreshold = AUTOHIDE_THRESHOLD_KBPS;
                break;
            case NETWORK_TRAFFIC_UNITS_MBPS:
                mAutoHideThreshold = AUTOHIDE_THRESHOLD_MBPS;
                break;
            default:
