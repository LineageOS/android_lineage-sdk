...
public final class TelephonyExtUtils {
    ...
    private final List<ProvisioningChangedListener> mListeners =
        ...
        mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (Intent.ACTION_BOOT_COMPLETED.equals(action)) {
                    ...
                    mNoServiceAvailable = !hasService();
    ...
    public int activateUiccCard(int slotId) {
        ...
        if (service != null) {
            try {
                ...
                Log.e(TAG, "Activating sub failed; phoneId " + slotId);
            }
        }
        return -1;
    }
    ...
    public int deactivateUiccCard(int slotId) {
        ...
        if (service != null) {
            try {
                ...
                Log.e(TAG, "Deactivating sub failed; phoneId " + slotId);
            }
        }
        return -1;
    }
