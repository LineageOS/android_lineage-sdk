...
public final class LineageNotificationLights {
    ...
    public void calcLights(LedValues ledValues, String packageName, Notification n,
        ...
        if (forcedOn) {
            ...
            // This is higher priority than mNotificationLedEnabled so that
            // battery light picker settings still work even if notification
            // led is turned off.
            enableLed = true;
        } else if (!mNotificationLedEnabled) {
            // Honor notification light on/off setting
            enableLed = false;
