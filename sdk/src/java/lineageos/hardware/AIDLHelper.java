...
class AIDLHelper {
    static DisplayMode[] fromAIDLModes(
            vendor.lineage.livedisplay.DisplayMode[] modes) {
    ...
    static DisplayMode fromAIDLMode(
            vendor.lineage.livedisplay.DisplayMode mode) {
