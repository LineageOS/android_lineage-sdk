    ...
    public boolean get(int feature) {
        ...
        try {
            if (isSupportedAIDL(feature)) {
                IBinder binder = mAIDLMap.get(feature);
                switch (feature) {
                    case FEATURE_HIGH_TOUCH_POLLING_RATE:
                        vendor.lineage.touch.IHighTouchPollingRate highTouchPollingRate = vendor.lineage.touch.IHighTouchPollingRate.Stub.asInterface(binder);
                        return highTouchPollingRate.getEnabled();
                    case FEATURE_HIGH_TOUCH_SENSITIVITY:
                        vendor.lineage.touch.IGloveMode gloveMode = vendor.lineage.touch.IGloveMode.Stub.asInterface(binder);
                        return gloveMode.getEnabled();
                    case FEATURE_KEY_DISABLE:
                        vendor.lineage.touch.IKeyDisabler keyDisabler = vendor.lineage.touch.IKeyDisabler.Stub.asInterface(binder);
                        return keyDisabler.getEnabled();
                    case FEATURE_KEY_SWAP:
                        vendor.lineage.touch.IKeySwapper keySwapper = vendor.lineage.touch.IKeySwapper.Stub.asInterface(binder);
                        return keySwapper.getEnabled();
                    case FEATURE_TOUCH_HOVERING:
                        vendor.lineage.touch.IStylusMode stylusMode = vendor.lineage.touch.IStylusMode.Stub.asInterface(binder);
                ...
                switch (feature) {
                    ...
                    case FEATURE_KEY_SWAP:
                        vendor.lineage.touch.V1_0.IKeySwapper keySwapper = (vendor.lineage.touch.V1_0.IKeySwapper) obj;
    ...
    public TouchscreenGesture[] getTouchscreenGestures() {
        try {
            if (isSupportedAIDL(FEATURE_TOUCHSCREEN_GESTURES)) {
                vendor.lineage.touch.ITouchscreenGesture touchscreenGesture = vendor.lineage.touch.ITouchscreenGesture.Stub.asInterface(
                ...
                vendor.lineage.touch.V1_0.ITouchscreenGesture touchscreenGesture = (vendor.lineage.touch.V1_0.ITouchscreenGesture)
