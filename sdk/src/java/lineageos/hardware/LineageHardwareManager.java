...
public final class LineageHardwareManager {
     ...
     */
    @VisibleForTesting
    public static final int FEATURE_HIGH_TOUCH_SAMPLE_RATE = 0x8;
    ...
    private static final List<Integer> BOOLEAN_FEATURES = Arrays.asList(
        ...
        FEATURE_HIGH_TOUCH_SAMPLE_RATE,
        FEATURE_KEY_DISABLE,
        FEATURE_KEY_SWAP,
    ...
    private IBase getHIDLService(int feature) {
        try {
            switch (feature) {
                ...
                case FEATURE_HIGH_TOUCH_SAMPLE_RATE:
                    return ITouchSampling.getService(true);
        ...
        try {
            if (isSupportedHIDL(feature)) {
                ...
                switch (feature) {
                    ...
                    case FEATURE_HIGH_TOUCH_SAMPLE_RATE:
                        ITouchSampling touchSampling = (ITouchSampling) obj;
                        return touchSampling.isEnabled();
                    case FEATURE_KEY_DISABLE:
        ...
        try {
            if (isSupportedHIDL(feature)) {
                ...
                switch (feature) {
                    ...
                    case FEATURE_HIGH_TOUCH_SAMPLE_RATE:
                        ITouchSampling touchSampling = (ITouchSampling) obj;
                        return touchSampling.setEnabled(enable);
                    case FEATURE_KEY_DISABLE:
                        IKeyDisabler keyDisabler = (IKeyDisabler) obj;
