...
import lineageos.app.ICMStatusBarManager;
...
public class CMStatusBarManager {
    ...
    private CMStatusBarManager(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                lineageos.app.CMContextConstants.Features.STATUSBAR) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link lineageos.app.CMStatusBarManager}
     * @param context
     * @return {@link lineageos.app.CMStatusBarManager}
     */
    ...
    /**
     * Similar to {@link lineageos.app.CMStatusBarManager#publishTile(int id, lineageos.app.CustomTile)},
    ...
    /**
     * Similar to {@link lineageos.app.CMStatusBarManager#removeTile(String tag, int id)}
