...
public final class LineageSettings {
    ...
    public static final class System extends Settings.NameValueTable {
        ...
        /**
         * Wether to mute audio by pressing the volume up and down keys simultneously on Android TV, the value is boolean.
         * 0 = 0ff, 1 = on
         */
        public static final String VOLUME_UP_AND_DOWN_MUTE = "back_and_home_sleep";
        ...
        static {
            ...
            VALIDATORS.put(VOLUME_UP_AND_DOWN_MUTE, VOLUME_BACK_AND_HOME_MUTE_VALIDATOR);
