...
public final class LineageSettings {
    ...
    public static final class System extends Settings.NameValueTable {
        ...
        /**
         * Wether to put device to sleep by pressing the back and home keys simultneously on Android TV, the value is boolean.
         * 0 = 0ff, 1 = on
         */
        public static final String BACK_AND_HOME_SLEEP = "back_and_home_sleep";

        /** @hide */
        public static final Validator BACK_AND_HOME_SLEEP_VALIDATOR =
                sBooleanValidator;
        ...
        static {
            ...
            VALIDATORS.put(BACK_AND_HOME_SLEEP, BACK_AND_HOME_SLEEP_VALIDATOR);
