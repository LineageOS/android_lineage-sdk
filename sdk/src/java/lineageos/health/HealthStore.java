...
public class HealthStore {
    ...
    private HealthStore(Context context) {
     ...
     */
    public static HealthStore getInstance(Context context) {
        if (sInstance == null) {
    ...
    /**
     * Write the user's {@link lineageos.health.HumanInfo}
     *
     * You will need {@link #HEALTH_STORE_WRITE_PERMISSION}
     * to utilize this functionality.
     *
    ...
    public boolean writeHumanInfo(HumanInfo info) {
        if (sService == null) return false;
        try {
            return sService.writeHumanInfo(info);
        } catch (RemoteException e) {
            Log.e(TAG, e.getLocalizedMessage(), e);
        }
        return false;
    ...
    /**
     * Read the user's {@link lineageos.health.HumanInfo}
     *
     * You will need {@link #HEALTH_STORE_READ_PERMISSION}
     * to utilize this functionality.
     *
    ...
    public HumanInfo getHumanInfo() {
        if (sService == null) return new HumanInfo();
        try {
            return sService.getHumanInfo();
        } catch (RemoteException e) {
            Log.e(TAG, e.getLocalizedMessage(), e);
        }
