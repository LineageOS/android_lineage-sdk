...
public class MedicalProfile implements Parcelable {
     ...
     */
    public MedicalProfile(
            int biologicalSex, float height,
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return biologicalSex == that.biologicalSex &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(biologicalSex, height, bloodType,
                organDonor, allergies, medications,
                conditions, notes);
    }
}
