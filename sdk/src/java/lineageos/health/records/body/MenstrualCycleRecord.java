...
public class MenstrualCycleRecord extends SimpleIntRecord {
    ...
    public MenstrualCycleRecord(Date time, int value) {
        this(UNSET_UID, time, value);
    }

    public MenstrualCycleRecord(long uid, Date time, int value) {
        super(uid, time, CATEGORY, value);
    }

    /** @hide */
    public MenstrualCycleRecord(byte[] bytes) {
        super(bytes);
    }

    @Override
    public boolean validate() {
        return value >= 1 && value <= 4 && super.validate();
    }
}
