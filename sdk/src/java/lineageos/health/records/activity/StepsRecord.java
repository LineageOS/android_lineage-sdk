...
public class StepsRecord extends SimpleIntRecord {
    public static final int CATEGORY = 402;

    public StepsRecord(Date begin, Date end, int value) {
        this(UNSET_UID, begin, end, value);
    }

    public StepsRecord(long uid, Date begin, Date end, int value) {
        super(uid, begin, end, CATEGORY, value);
    }
