...
public class WorkoutRecord extends Record {
    public static final int CATEGORY = 403;

    private int calories;
    @NonNull
    private String notes = "";

    public WorkoutRecord(Date begin, Date end, int calories) {
        this(UNSET_UID, begin, end, calories, "");
    }

    public WorkoutRecord(Date begin, Date end,
            int calories, @NonNull String notes) {
        this(UNSET_UID, begin, end, calories, notes);
    }

    public WorkoutRecord(long uid, Date begin, Date end, int calories) {
        this(uid, begin, end, calories, "");
    }

    public WorkoutRecord(long uid, Date begin, Date end,
            int calories, @NonNull String notes) {
    ...
    public String toString() {
        return String.format(
            ...
            uid, time.getTime(), end.getTime(), calories, notes
        );
    }
}
