...
public abstract class SimpleIntRecord extends Record {
    ...
    public SimpleIntRecord(long time, int category, int value) {
        super(time, category);
        this.value = value;
    }

    public SimpleIntRecord(long uid, long time, int category, int value) {
        super(uid, time, category);
        this.value = value;
    }

    public SimpleIntRecord(long uid, long time, long duration,
    ...
    public String toString() {
        return String.format(
            "Record { uid: %1$d, time: %2$d; duration: %3$d; category: %4$d; value: %5$d }",
