...
public abstract class SimpleFloatRecord extends Record {
    ...
    public SimpleFloatRecord(long uid, Date time, int category, float value) {
        super(uid, time, category);
        this.value = value;
    }

    public SimpleFloatRecord(long uid, Date begin, Date end,
    ...
    public String toString() {
        return String.format(
            "Record { uid: %1$d, time: %2$d; end: %3$d; category: %4$d; value: %5$.2f }",
