...
/**
 * Hearth rate measured in Beats Per Minute (BPM).
 *
 * <a href="https://en.wikipedia.org/wiki/Heart_rate">More info</a>
 */
public final class HearthRateRecord extends SimpleIntRecord {
    public static final int CATEGORY = 3; // 0-03

    public HearthRateRecord(long time, int value) {
        super(time, CATEGORY, value);
    }

    public HearthRateRecord(long uid, long time, int value) {
        super(uid, time, CATEGORY, value);
    }

    /** @hide */
    public HearthRateRecord(byte[] bytes) {
        super(bytes);
    }
