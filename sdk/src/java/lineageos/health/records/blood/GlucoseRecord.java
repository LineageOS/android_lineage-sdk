...
public final class GlucoseRecord extends Record {
    ...
    public GlucoseRecord(Date time, float value, boolean beforeMeal) {
        this(UNSET_UID, time, value, beforeMeal, -1f, -1f);
    }
    ...
    public GlucoseRecord(long uid, Date time, float value, boolean beforeMeal,
                         float insulin, float basalInsulin) {
    ...
    public String toString() {
        return String.format(
            "Record { uid: %1$d, time: %2$d; value: %3$.2f; " +
            "beforeMeal: %4$s; insulin: %5$.1f; basalInsulin: %6$.1f }",
            uid, time.getTime(), value, String.valueOf(beforeMeal),
