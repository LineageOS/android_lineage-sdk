 ...
 *
 * If you are creating a custom Record type, please override the following
 * methods to assure your data is properly stored.
 * {@link #getCategory()}
 * {@link #writeValueTo(android.os.Parcel)}
 * {@link #readValueFrom(android.os.Parcel)}
 */
public class Record implements Parcelable {
    ...
    /** @hide */
    public Record(@NonNull byte[] bytes) {
