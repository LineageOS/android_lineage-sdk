...
public class Record implements Parcelable {
     ...
     */
    public Record(long time, int category) {
        this(UNSET_UID, time, 0L, category);
    }
     ...
     * @param category The category of the record
     */
    public Record(long uid, long time, int category) {
        this(uid, time, 0L, category);
    }
     ...
     * @param category The category of the record
     */
    public Record(long uid, long time, long duration, int category) {
        this.uid = uid;
        this.time = time;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(time, duration, category);
    }
    ...
    public String toString() {
        return String.format(
            "Record { uid: %1$d, time: %2$d; duration: %3$d; category: %4$d }",
            uid, time, duration, category
        );
    }
