...
public class ChargingControlController extends LineageHealthFeature {
    ...
    private static final SimpleDateFormat mDateFormatter = new SimpleDateFormat("$format");
    ...
    private static class ChargingStopReason {
         ...
         * No stop charging
         */
        public static final int NONE = BIT(0);

        /**
         * The charging stopped because it reaches limit
         */
        public static final int REACH_LIMIT = BIT(1);
         ...
         */
        public static final int WAITING = BIT(2);
    }
    ...
    public boolean isChargingControlBypassesBattery() {
        try {
            return mChargingControl.deviceChargingControlBypassesBattery();
