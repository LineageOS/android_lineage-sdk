...
abstract class AltSQLiteOpenHelper {
     ...
     */
    public AltSQLiteOpenHelper(@Nullable File dbFile,
     ...
     */
    public AltSQLiteOpenHelper(@Nullable File dbFile, int version,
    ...
    /**
     * Return the path of the SQLite database being opened, as given to
     * the constructor.
     */
    ...
    public void setOpenParams(@NonNull SQLiteDatabase.OpenParams openParams) {
        if (openParams == null) throw new IllegalArgumentException("openParams must not be null");
        synchronized (this) {
            if (mDatabase != null && mDatabase.isOpen()) {
                throw new IllegalStateException(
