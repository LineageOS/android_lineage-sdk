...
/**
 * vendor.lineage.accessories.IAccessory <-> lineageos.accessories.IAccessory
 */
class Accessory private constructor(
    ...
    private val accessoryCallback = object : vendor.lineage.accessories.IAccessoryCallback.Stub() {
        override fun onAccessoryInfoUpdated(
            ...
            } ?: throw Exception("Received null AccessoryInfo, this shouldn't happen")
        }
    ...
    private val service = object : IAccessory.Stub() {
        ...
        override fun registerCallback(callback: IAccessoryCallback) {
            ...
            callback.onAccessoryInfoUpdated(this@Accessory.accessoryInfo)
            callback.onAccessoryStatusUpdated(this@Accessory.accessoryStatus)
            callback.onBatteryInfoUpdated(this@Accessory.batteryInfo)
        }
    ...
    companion object {
        ...
        private fun vendor.lineage.accessories.BatteryInfo?.toFwk() = this?.run {
            BatteryInfo().also {
