...
public class HealthInterfaceService extends LineageSystemService {
    ...
    private boolean shouldSetWaitFlag() {
        ...
        if (isChargingReasonSet(ChargingStopReason.STOP_REASON_WAITING)) {
    ...
    private void updateChargingStopReason() {
        ...
        setChargingReason(ChargingStopReason.STOP_REASON_REACH_LIMIT, shouldSetLimitFlag());
        setChargingReason(ChargingStopReason.STOP_REASON_WAITING, shouldSetWaitFlag());
    }
