...
public class HealthInterfaceService extends LineageSystemService {
    ...
    public void onBootPhase(int phase) {
        if (mChargingControl == null || phase != PHASE_BOOT_COMPLETED) {
            return;
        }
        ...
        try {
            mIsChargingEnabled = mChargingControl.getChargingEnabled();
    ...
    private void postBatteryHealthNotification() {
        ...
        String message = String.format(
                mContext.getString(R.string.charging_control_notification_content),
        ...
        Notification.Builder notification =
                new Notification.Builder(mContext, BATTERY_HEALTH_CHANNEL_ID)
    ...
    private void updateChargeState() {
        ...
        if (mIsChargingEnabled != (mChargingStopReason == 0)) {
            try {
                ...
                mChargingControl.setChargingEnabled(mIsChargingEnabled);
