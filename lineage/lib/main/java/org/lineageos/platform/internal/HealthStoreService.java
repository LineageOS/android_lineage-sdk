...
public class HealthStoreService extends LineageSystemService {
    ...
    public boolean setMedicalProfileImpl(MedicalProfile profile) {
        return mRepo.writeMedicalProfile(profile);
    }

    public MedicalProfile getMedicalProfileImpl() {
    ...
    private final IBinder mService = new IHealthStore.Stub() {
        ...
        @Override
        public void setMedicalProfile(MedicalProfile profile) {
            enforceWritePermission();
